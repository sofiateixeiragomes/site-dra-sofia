          ...
          el('div', { class: 'next-steps-grid' }, [
            ...
            el('div', { class: 'next-step-card' }, [
              ...
              el('a', {
                ...
                href: 'https://wa.me/5585991173462?text=Ol%C3%A1!%20Acabei%20de%20fazer%20o%20Check-up%20Mental%20no%20site%20e%20gostaria%20de%20agendar%20uma%20consulta.',
                target: '_blank',
    ...
    const container = el('section', { class: 'quiz-view lead-sent-view' }, [
      el('div', { class: 'container quiz-narrow center-text' }, [
        ...
        el('div', { class: 'quiz-cta-group' }, [
          el('a', {
            class: 'btn btn-primary',
            href: 'https://wa.me/5585991173462?text=Ol%C3%A1!%20Acabei%20de%20fazer%20o%20Check-up%20Mental%20e%20gostaria%20de%20agendar%20uma%20consulta.',
            target: '_blank'
